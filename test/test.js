...
describe( 'distributions-laplace-pdf', function tests() {
	...
	it( 'should evaluate the Laplace pdf element-wise and return an array of a specific type', function test() {
	...
	it( 'should evaluate the Laplace pdf element-wise using an accessor', function test() {
		var data, actual, expected, i;
	...
	it( 'should evaluate the Laplace pdf element-wise and deep set', function test() {
		var data, actual, expected, i;
	...
	it( 'should evaluate the Laplace pdf element-wise when provided a matrix', function test() {
		var mat,
			out,
			d1,
			d2,
	...
	it( 'should evaluate the Laplace pdf element-wise and return a matrix of a specific type', function test() {
		var mat,
			out,
			d1,
			d2,
